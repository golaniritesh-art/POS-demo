...
1. `domain-knowledge` skill — Start here for overview and data models
2. `domain-knowledge` sub-files — Read `./business-logic.md` and `./POS_UX_guide.md` for detailed rules and flows
3. `POS_UX_guide.md` — Actual UI flows
4. `./business-logic.md` — Business logic and validation rules
